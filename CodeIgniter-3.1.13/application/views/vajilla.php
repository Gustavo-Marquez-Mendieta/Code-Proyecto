        ...
        <div class="full-box dashboard-sideBar-ct">
            ...
            <div class="full-box dashboard-sideBar-UserInfo">
                ...
                <ul class="full-box list-unstyled text-center">
                    ...
                    <li>
                        <a href="<?php echo site_url('Welcome/informacionUsuario'); ?>" title="Mis Reservas"
                            class="btn-user">
                ...
                <div class="col-md-6">
                    <?php foreach ($productos as $row) { ?>
                        <div class="col-12 col-md-4 mt-5 text-center Products">
                            <div class="card">
                                <div>
                                    <img class="card-img-top" src="<?php echo base_url('./assets/img/' . $row->imagen); ?>"
                                        alt="<?php echo $row->nombre; ?>"
                                        style="max-width: 200px; max-height: 200px; object-fit: cover;">
                                </div>
                                <div class="card-body text-center">
                                    <h5 class="card-title card_title"><?php echo $row->nombre; ?></h5>
                                    <p class="card-text p_puntos">Caja de <?php echo $row->cantidad; ?> unidades <br>
                                        Bs. <?php echo $row->precio; ?><br>
                                        <span class="stock">Cajas disponibles <?php echo $row->stock_cajas; ?></span>
                                    </p>
                                    ...
                                    <a href="#" class="red_button btn_puntos agregar-carrito"
                                        data-id="<?php echo $row->vajilla_id; ?>"
    ...
    <script>
        $(document).ready(function () {
            $('.btn-increase').click(function () {
                ...
                var currentStock = parseInt(stockSpan.text().split(" ")[2]);

                if (currentStock > 0) {
                    quantitySpan.text(currentQuantity + 1);
                    stockSpan.text("Cajas disponibles " + (currentStock - 1));
                } else {
            ...
            $('.agregar-carrito').click(function (e) {
                ...
                if (quantity > 0) {
                    window.location.href = "<?php echo site_url('Welcome/agregar_al_carrito/vajilla'); ?>/" + productId + "/" + quantity;
                } else {
