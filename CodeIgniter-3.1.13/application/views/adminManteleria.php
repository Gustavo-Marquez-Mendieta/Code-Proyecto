    ...
    <section class="full-box dashboard-contentPage" id="inicio">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <!-- Sección del formulario para agregar nueva decoración -->
                    <div class="col-md-6">
                        <?php if (isset($error)) : ?>
                        ...
                        <form action="<?php echo site_url('Welcome/agregarDecoracion'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary">Agregar Decoración</button>
                            <a href="<?php echo site_url('Welcome/adminDecoraciones'); ?>" class="btn btn-primary">Ver Decoraciones</a>
                        </form>
                    </div>
                </div>
            </div>
