        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="frase">"Lista de Bebidas"</h1>
                </div>
                <div class="col-md-10">
                            ...
                            <?php if (!empty($bebidas)) : ?>
                                <?php foreach ($bebidas as $bebida) : ?>
                                    <tr>
                                        ...
                                        <td><?= $bebida['nombre']; ?></td>
                                        <td><?= $bebida['ingredientes']; ?></td>
                                        <td><img src="<?= base_url('./assets/img/' . $bebida['imagen']); ?>" alt="<?= $bebida['nombre']; ?>" width="50"></td>
                                        <td>
                                            <a href="<?= site_url('Welcome/editarBebida/' . $bebida['bebida_id']); ?>" class="btn btn-primary btn-edit">Editar</a>
                                            <a href="<?= site_url('Welcome/deleteBebida/' . $bebida['bebida_id']); ?>" class="btn btn-danger btn-delete" onclick="return confirm('¿Estás seguro de eliminar este elemento?');">Eliminar</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
