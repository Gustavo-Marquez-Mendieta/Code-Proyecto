        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="frase">"Lista de Decoraciones"</h1>
                </div>
                <div class="col-md-10">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php if (!empty($decoraciones)) : ?>
                                <?php foreach ($decoraciones as $item) : ?>
                                    <tr>
                                        <td><?= $item['decoracion_id']; ?></td>
                                        <td><?= $item['tipo']; ?></td>
                                        <td><?= $item['precio']; ?></td>
                                        <td><?= $item['plan']; ?></td>
                                        <td><img src="<?= base_url('./assets/img/' . $item['imagen']); ?>" alt="<?= $item['tipo']; ?>" width="50"></td>
                                        <td>
                                            <a href="<?= site_url('Welcome/editarDecoracion/' . $item['decoracion_id']); ?>" class="btn btn-primary btn-edit">Editar</a>
                                            <a href="<?= site_url('Welcome/deleteDecoracion/' . $item['decoracion_id']); ?>" class="btn btn-danger btn-delete" onclick="return confirm('¿Estás seguro de eliminar este elemento?');">Eliminar</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
