                        ...
                        <tbody>
                            <?php if (!empty($decoracion)) : ?>
                                <?php if (isset($decoracion) && is_array($decoracion)) : ?>
                                    <form action="<?php echo site_url('Welcome/editarDecoracion/' . $decoracion['decoracion_id']); ?>" method="post" enctype="multipart/form-data">

                                        <input type="hidden" name="decoracion_id" value="<?php echo htmlspecialchars($decoracion['decoracion_id']); ?>">
                                        <input type="hidden" name="imagen_actual" value="<?php echo htmlspecialchars($decoracion['imagen']); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="precio" id="precio" value="<?php echo htmlspecialchars($decoracion['precio']); ?>" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="<?php echo base_url('assets/img/' . $decoracion['imagen']); ?>" alt="Imagen actual" width="100">
                                        </div>
                                        <input type="submit" value="Actualizar" class="btn btn-primary">
                                        <a href="<?php echo site_url('Welcome/adminManteleria'); ?>" class="btn btn-danger">Cancelar</a>
                                    </form>
                                <?php else : ?>
