        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="frase">"Lista de Manteleria"</h1>
                </div>
                <div class="col-md-10">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php if (!empty($manteleria)): ?>
                                <?php foreach ($manteleria as $item): ?>
                                    <tr>
                                        <td><?= $item['manteleria_id']; ?></td>
                                        <td><?= $item['nombre']; ?></td>
                                        <td><?= $item['tipo']; ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= site_url('Welcome/deleteManteleria/' . $item['manteleria_id']); ?>"
