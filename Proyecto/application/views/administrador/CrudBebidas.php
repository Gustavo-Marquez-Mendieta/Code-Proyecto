                            ...
                            <?php if (!empty($bebidas)): ?>
                                <?php foreach ($bebidas as $bebida): ?>
                                    <tr>
                                        ...
                                        <td><img src="<?= base_url('./assets/img/' . $bebida['imagen']); ?>"
                                                alt="<?= $bebida['nombre']; ?>" width="50"></td>
                                        <td>
                                            <a href="<?= site_url('Welcome/editarBebida/' . $bebida['bebida_id']); ?>"
                                                class="btn btn-primary btn-edit">Editar</a>
                                            <a href="<?= site_url('Welcome/deleteBebida/' . $bebida['bebida_id']); ?>"
